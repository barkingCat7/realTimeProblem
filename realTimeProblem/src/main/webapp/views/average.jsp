...
<body>
	...
	<div class="limiter">
		<center>
			<h1 class="header">Average Value from 2 Date & Times</h1>
			...
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-110">
					<table data-vertable="ver1">
						<thead>
						<h2>Average Value for this range is: ${averageVal}</h2>
						<h3>List of Records in this range: </h3>
